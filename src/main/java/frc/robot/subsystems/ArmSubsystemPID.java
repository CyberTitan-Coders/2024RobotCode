...
//       }*/
//       while (rightArmAbsoluteEncoder.getPosition()<Constants.desiredEncoderValue.kSpeakerArmAngle){
//         setArm(Constants.operatorStuff.kArmSpeed);
//         }
//     },
...
//     // When the command is initialized, set the wheels to the intake speed values
//     () -> {
//       while (rightArmAbsoluteEncoder.getPosition()>Constants.desiredEncoderValue.kIntakeArmAngle){
//       setArm(-(Constants.operatorStuff.kArmSpeed));
//       }
...
//         setArm(-(Constants.operatorStuff.kArmSpeed));
//         }*/
//         while (rightArmAbsoluteEncoder.getPosition()<Constants.desiredEncoderValue.kAmpArmAngle){
//           setArm(Constants.operatorStuff.kArmSpeed);
//           }
//     },
//     // When the command stops, stop the wheels
...
//     // When the command is initialized, set the wheels to the intake speed values
//     () -> {
//       setArm(operatorStuff.kArmSpeed);
//     },
//     // When the command stops, stop the wheels
//     () -> {
//       stop();
